...
import 'post_share_comp_model.dart';
export 'post_share_comp_model.dart';

class PostShareCompWidget extends StatefulWidget {
  const PostShareCompWidget({
    super.key,
    required this.post,
    bool? isShort,
  ...
  @override
  State<PostShareCompWidget> createState() => _PostShareCompWidgetState();
}

class _PostShareCompWidgetState extends State<PostShareCompWidget> {
  late PostShareCompModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PostShareCompModel());
