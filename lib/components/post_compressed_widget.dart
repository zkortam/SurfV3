...
import 'post_compressed_model.dart';
export 'post_compressed_model.dart';

class PostCompressedWidget extends StatefulWidget {
  const PostCompressedWidget({
    super.key,
    required this.post,
  });
  ...
  @override
  State<PostCompressedWidget> createState() => _PostCompressedWidgetState();
}

class _PostCompressedWidgetState extends State<PostCompressedWidget>
    with TickerProviderStateMixin {
  late PostCompressedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PostCompressedModel());
