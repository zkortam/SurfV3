...
import 'comment_comp_edit_model.dart';
export 'comment_comp_edit_model.dart';

class CommentCompEditWidget extends StatefulWidget {
  const CommentCompEditWidget({
    super.key,
  ...
  @override
  State<CommentCompEditWidget> createState() => _CommentCompEditWidgetState();
}

class _CommentCompEditWidgetState extends State<CommentCompEditWidget> {
  late CommentCompEditModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CommentCompEditModel());
                        ...
                        child: FlutterFlowIconButton(
                          ...
                          onPressed: () async {
                            await widget.comment!
                              ...
                              text: _model.captionTextController.text,
                            ));
                            Navigator.pop(context);
                          },
                        ),
