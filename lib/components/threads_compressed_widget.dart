...
import 'threads_compressed_model.dart';
export 'threads_compressed_model.dart';

class ThreadsCompressedWidget extends StatefulWidget {
  const ThreadsCompressedWidget({
    super.key,
  ...
  @override
  State<ThreadsCompressedWidget> createState() =>
      _ThreadsCompressedWidgetState();
}

class _ThreadsCompressedWidgetState extends State<ThreadsCompressedWidget> {
  late ThreadsCompressedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ThreadsCompressedModel());
