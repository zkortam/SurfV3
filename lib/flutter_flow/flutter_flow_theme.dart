...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color accent1 = const Color(0xFF781FB6);
  late Color accent2 = const Color(0xFF8D5AA6);
  late Color accent3 = const Color(0xFFA0A0A0);
  late Color accent4 = const Color(0xFFDCDCDC);
  late Color success = const Color(0xFF1B9E62);
  late Color warning = const Color(0xFFD1A11A);
  late Color error = const Color(0xFFD01C27);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color accent2 = const Color(0xFF8D5AA6);
  late Color accent3 = const Color(0xFFA0A0A0);
  late Color accent4 = const Color(0xFF0C0F10);
  late Color success = const Color(0xFF1B9E62);
  late Color warning = const Color(0xFFD1A11A);
  late Color error = const Color(0xFFD01C27);
  late Color info = const Color(0xFFFFFFFF);
